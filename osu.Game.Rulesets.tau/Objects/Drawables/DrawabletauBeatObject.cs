...
{
    public class DrawabletauBeatObject : DrawableTauHitObject, IKeyBindingHandler<TauAction>
    {
        public Box Box;

        public Func<DrawabletauBeatObject, bool> CheckValidation;

        /// <summary>
        /// A list of keys which can result in hits for this HitObject.
        /// </summary>
        public TauAction[] HitActions { get; set; } =
        {
