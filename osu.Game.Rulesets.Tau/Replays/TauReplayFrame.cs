...
namespace osu.Game.Rulesets.Tau.Replays
{
    public class TauReplayFrame : ReplayFrame, IConvertibleReplayFrame
    {
        ...
        public void FromLegacy(LegacyReplayFrame currentFrame, IBeatmap beatmap, ReplayFrame lastFrame = null)
        {
            ...
            if (currentFrame.MouseLeft2) Actions.Add(TauAction.LeftButton);
            if (currentFrame.MouseRight2) Actions.Add(TauAction.RightButton);
        }
        ...
        public LegacyReplayFrame ToLegacy(IBeatmap beatmap)
        {
            ...
            if (Actions.Contains(TauAction.LeftButton)) state |= ReplayButtonState.Left2;
            if (Actions.Contains(TauAction.RightButton)) state |= ReplayButtonState.Right2;
