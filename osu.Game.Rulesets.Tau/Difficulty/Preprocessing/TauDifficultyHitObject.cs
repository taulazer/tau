...
namespace osu.Game.Rulesets.Tau.Difficulty.Preprocessing
{
    public class TauDifficultyHitObject : DifficultyHitObject
    {
        ...
        /// <summary>
        /// Normalized distance from the end position of the previous <see cref="TauDifficultyHitObject"/> to the start position of this <see cref="TauDifficultyHitObject"/>.
        /// </summary>
        ...
        public new readonly TauHitObject LastObject;
            ...
            : base(hitObject, lastObject, clockRate)
        {
            ...
            LastObject = (TauHitObject)lastObject;
            Beatmap = beatmap;
        ...
        {
            Vector2 pos = Extensions.GetCircularPosition(30, hitObject.Angle);

            if (hitObject is Slider slider)
            {
                computeSliderCursorPosition(slider);
                pos = slider.EndPosition ?? pos;
            }
